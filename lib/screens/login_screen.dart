        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              Image.asset('assets/images/Balaiku.png', height: 120, errorBuilder: (c, e, s) => const Icon(Icons.home, size: 80, color: Colors.blue)),
              const SizedBox(height: 20),
              const Text('Selamat Datang', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
              const Text('Masuk atau Daftar untuk\nmengakses akun Anda', textAlign: TextAlign.center, style: TextStyle(color: Colors.grey)),
              const SizedBox(height: 20),
              const TabBar(
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF0D6EFD), minimumSize: const Size(double.infinity, 50), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
