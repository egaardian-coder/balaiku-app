...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 2,
      child: Scaffold(
        // Hapus backgroundColor: Colors.white agar mengikuti tema global
        body: SafeArea(
          child: Column(
            children: [
              ...
              Center(
                child: Image.asset('assets/images/Balaiku.png', height: 130, fit: BoxFit.contain),
              ),
  ...
  Widget _buildLoginTab(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          TextField(decoration: InputDecoration(labelText: 'Nomor Telephone', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), filled: true, fillColor: Colors.white)),
          const SizedBox(height: 20),
          TextField(obscureText: true, decoration: InputDecoration(labelText: 'Password', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), filled: true, fillColor: Colors.white)),
  ...
  Widget _buildRegisterTab(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          TextField(decoration: InputDecoration(labelText: 'NIK', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), filled: true, fillColor: Colors.white)),
          const SizedBox(height: 15),
          TextField(decoration: InputDecoration(labelText: 'Nomor Telephone', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), filled: true, fillColor: Colors.white)),
          const SizedBox(height: 15),
          TextField(decoration: InputDecoration(labelText: 'Alamat', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), filled: true, fillColor: Colors.white)),
          const SizedBox(height: 15),
          Row(
            children: [
              Expanded(child: TextField(decoration: InputDecoration(labelText: 'RT', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), filled: true, fillColor: Colors.white))),
              const SizedBox(width: 15),
              Expanded(child: TextField(decoration: InputDecoration(labelText: 'RW', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), filled: true, fillColor: Colors.white))),
            ],
          ),
          const SizedBox(height: 15),
          TextField(obscureText: true, decoration: InputDecoration(labelText: 'Password', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), filled: true, fillColor: Colors.white)),
